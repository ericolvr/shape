...
class TestUserHandlers:
    ...
    def test_create_user_duplicate_email(self, client, mock_user_service):
        mock_user_service.create.side_effect = DuplicateEmailError("Email 'joao@example.com' already exists")
    ...
    def test_create_user_validation_error(self, client, mock_user_service):
        ...
        response = client.post(
            "/users/",
            json={"name": "João Silva", "email": "invalid-email"}
        )
    ...
    def test_update_user_success(self, client, mock_user_service):
        ...
        response = client.put(
            "/users/1",
            json={"name": "João Updated", "email": "joao.updated@example.com"}
        )
    ...
    def test_update_user_duplicate_email(self, client, mock_user_service):
        ...
        response = client.put(
            "/users/1",
            json={"name": "João Silva", "email": "maria@example.com"}
        )
    ...
    def test_update_user_validation_error(self, client, mock_user_service):
        ...
        response = client.put(
            "/users/1",
            json={"name": "João Silva", "email": "invalid"}
        )
